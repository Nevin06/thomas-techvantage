...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 16 14:09:28 2018
...
def detectRegionsOfInterest(frame, cascade):
    ...
    for (x,y,w,h) in cars:
            ...
            if y > minY:
                ...
                ##diffX = 3852.0947265625             ##
                diffY = round(diffUpDown(roiImage))
                ##diffY = 3576.17333984375       ##
...
def detectCars(filename):
    rectangles = []
    cascade = cv2.CascadeClassifier('/Users/apple/Desktop/Project/GitHub/Car-detection/cars.xml')
...
detectCars('/Users/apple/Desktop/Project/GitHub/Car-detection/video.avi')
